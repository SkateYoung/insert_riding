...
class CoreDispatcher:
    ...
    def evaluate_route(route, vehicle_state, on_board_orders, city_map, capacity=10, v_zone=None):
        ...
        # 保留原有的核心调优参数
        ALPHA_1 = 2.0    # 空驶里程倍率惩罚 
        ALPHA_2 = 0.5    # 载客有效里程指标 
        ...
        # # 3. 基础油耗成本 (绝对物理成本)
        # # 注意：这里用 ALPHA_1/ALPHA_2 是为了兼容后续可能调整的参数
        # # empty_dist为空驶距离，loaded_dist为载客距离
        # base_fuel_cost = (empty_dist * ALPHA_1) + (loaded_dist * ALPHA_2)
        ...
        # fairness_cost = current_load * 500.0 
        fairness_cost = 0.0 
